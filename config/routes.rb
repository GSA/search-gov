ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :affiliates, :controller => 'affiliates/home', :member => { :push_content_for => :post, :embed_code => :get, :edit_site_information => :get, :update_site_information => :put, :edit_look_and_feel => :get, :update_look_and_feel => :put }, :collection => { :home => :get, :how_it_works => :get, :demo => :get, :update_contact_information => :put }, :except => [:edit, :update] do |affiliate|
