module Jobs
  ...
  JOB_RELATED_KEYWORDS = '((position|opening|posting|job|employment|' \
                         'intern(ship)?|seasonal|trabajo|puesto|empleo|vacante+?)(s\b|\b)|' \
                         '(opportunit|vacanc)(y|ies))|(posicion|ocupacion|' \
                         'oportunidad|federal)(es)?|gobierno'.freeze
  ...
  BLOCKED_PHRASES = '(job|employment) (contract|law|training|safety)s?'.freeze
  BLOCKED_KEYWORDS =
