class YoutubeUploadedVideosParser
  ...
  def next_uploaded_videos_url(document)
    ...
    uploaded_videos_url(start_index + per_page) if (start_index + per_page) <= [total, MAX_UPLOADED_VIDEO_COUNT].min
  end
end
