...
namespace :searchgov do
  ...
  CSS_PROPERTY_COLOR  = %i[search_button_background_color header_background_color header_text_color footer_background_color footer_background_color footer_links_text_color footer_links_text_color footer_links_text_color navigation_background_color left_tab_text_color navigation_link_color navigation_link_color header_tagline_background_color header_tagline_color title_link_color visited_title_link_color url_link_color description_text_color].freeze
