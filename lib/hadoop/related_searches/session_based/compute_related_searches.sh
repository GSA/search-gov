...
# related_searches_by_session.pig & convert_tfidf_to_json.py streaming script to convert related searches to json

# TODO:  , (1) explode out related_searches keys by using query_dictionary.txt
