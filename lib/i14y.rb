...
module I14y
  ...
  def self.host
    ENV['I14Y_HOST'] || Rails.application.secrets.i14y[:host]
  end

  def self.admin_user
    ENV['I14Y_ADMIN_USER'] || Rails.application.secrets.i14y[:admin_user]
  end

  def self.admin_password
    ENV['I14Y_ADMIN_PASSWORD'] || Rails.application.secrets.i14y[:admin_password]
  end
