...
ActiveRecord::Schema.define(version: 2021_10_15_171400) do
  ...
  create_table "featured_collections", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.datetime "rackspace_image_updated_at"
  ...
  create_table "federal_register_agencies", id: :integer, default: nil, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.datetime "last_load_documents_requested_at"
    t.datetime "last_successful_load_documents_at"
    t.integer "parent_id"
  end
  ...
  create_table "searchgov_domains", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
  ...
  create_table "sitemaps", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "searchgov_domain_id"
