...
describe('SearchResultsLayout', () => {
  it('renders all relevant links', () => {
    render(<SearchResultsLayout params={{}} resultsData={{ results: [], totalPages: 1, unboundedResults: false }} vertical='web' translations={translations} fontsAndColors={fontsAndColors} />);
  ...
  it('renders search results', () => {
    ...
    render(<SearchResultsLayout params={{ query: 'foo' }} resultsData={resultsData} vertical='web' translations={translations} fontsAndColors={fontsAndColors} />);
  ...
  it('renders text best bets', () => {
    ...
    const resultsData = { totalPages: 2, unboundedResults: true, results };
    render(<SearchResultsLayout params={{ query: 'foo' }} resultsData={resultsData} additionalResults={additionalResults} vertical='web' translations={translations} fontsAndColors={fontsAndColors} />);
  ...
  it('renders image search results', () => {
    ...
    render(<SearchResultsLayout params={{ query: 'foo' }} resultsData={resultsData} vertical='image' translations={translations} fontsAndColors={fontsAndColors} />);
