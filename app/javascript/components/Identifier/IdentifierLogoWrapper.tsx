...
import { Identifier as IdentifierLogos, IdentifierLogo, Link, IdentifierLinkItem, IdentifierLink } from '@trussworks/react-uswds';
...
export const IdentifierLogoWrapper = ({ logoUrl, logoAltText }: IdentifierProps) => {
