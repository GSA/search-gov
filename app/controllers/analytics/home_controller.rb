class Analytics::HomeController < Analytics::AnalyticsController
  def index
    ...
    @most_recent_day_biggest_movers = DailyQueryStat.biggest_movers(@day_being_shown, 1, @num_results_qas)
    @weekly_biggest_movers = DailyQueryStat.biggest_movers(@day_being_shown, 7, @num_results_qas)
    @monthly_biggest_movers = DailyQueryStat.biggest_movers(@day_being_shown, 30, @num_results_qas)
  end
end