class Analytics::HomeController < ApplicationController
  ...
  def index
    ...
    @yesterday_biggest_movers = QueryAcceleration.biggest_movers_over_window(1)
    @weekly_biggest_movers = QueryAcceleration.biggest_movers_over_window(7)
    @monthly_biggest_movers = QueryAcceleration.biggest_movers_over_window(30)
  end
end