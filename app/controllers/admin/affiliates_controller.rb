class Admin::AffiliatesController < Admin::AdminController
  ...
  active_scaffold :affiliate do |config|
    ...
    enable_disable_column_regex = /^(is\_|dap_enabled|force_mobile_format|gets_blended_results|gets_commercial_results_on_blended_search|jobs_enabled|raw_log_access_enabled|gets_i14y_results)/.freeze
