...
#       let(:searchgov_url) { instance_double(SearchgovUrl, destroy: false) }
#       let(:searchgov_urls) { double('SearchgovUrls', find_each: [searchgov_url].each) }
#       let!(:searchgov_domain) { instance_double(SearchgovDomain, searchgov_urls: searchgov_urls, id: 999, destroy: true) }
#
