...
describe Analytics::QueryGroupsController do
  ...
  context "do POST on #bulk_add" do
    context "when not logged in" do
      it "should redirect to the login page" do
        post :bulk_add
        response.should redirect_to(login_path)
    ...
    context "when logged in as an analyst admin" do
      ...
      it "should redirect to analytics_queries_path" do
        post :bulk_add
        response.should redirect_to(analytics_queries_path)
      end
    end
  end
end
