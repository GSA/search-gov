...
describe Sites::ClickDrilldownsController do
  ...
  describe '#show' do
    ...
    context 'when affiliate is downloading click CSV data' do
      ...
      before do
        ES::client_reader.stub(:search).and_return(drilldown_clicks_response)
      end

      it 'should generate a CSV of various click fields' do
        get :show, url:'http://some.gov.url/super_long_so_truncate_at_50/blah.cfm', start_date: '2015-02-01', end_date: '2015-02-05', format: 'csv'
        ...
        response.body.should contain("2015-02-01,10:23:58,206.53.115.243,US,SC,\"Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.93 Safari/537.36\",Other,Chrome,Windows,/clicked?a=usagov&l=en&q=the+constitution+and+the+bill+of+rights&s=BWEB&t=1422786234&v=web&u=http%3A%2F%2Fwww.archives.gov%2Fexhibits%2Fcharters%2Fbill_of_rights.html&p=2,http://search.usa.gov/search?affiliate=usagov&query=the+constitution+and+the+bill+of+rights,web,BWEB,2,the constitution and the bill of rights")
      end
    end
  end
end
