...
describe "layouts/affiliate" do
  before do
    ...
    affiliate = stub('affiliate', :exclude_webtrends? => false, :header => 'header', :footer => 'footer', :is_sayt_enabled => false, :is_affiliate_suggestions_enabled => false, :affiliate_template => affiliate_template)
  ...
  context "when exclude_webtrends flag is set to true" do
    before do
      affiliate_template = stub('affiliate template', :stylesheet => 'default')
      affiliate = stub('affiliate', :exclude_webtrends? => true, :header => 'header', :footer => 'footer', :is_sayt_enabled => false, :is_affiliate_suggestions_enabled => false, :affiliate_template => affiliate_template)
      assign(:affiliate, affiliate)
    end
