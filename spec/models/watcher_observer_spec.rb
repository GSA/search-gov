...
describe WatcherObserver do
  ...
  describe "after_save" do
    it "sets up the watch in Elasticsearch" do
      expect(ES.client_reader.watcher).to receive(:put_watch).with(id: 123, body: 'body')
  ...
  describe "after_destroy" do
    it "deletes the watch in Elasticsearch" do
      expect(ES.client_reader.watcher).to receive(:delete_watch).with(id: 123, force: true)
