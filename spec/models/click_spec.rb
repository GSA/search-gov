    ...
    context 'when it is some sort of boosted content click' do
      ...
      context 'when affiliate does not exist' do
        it 'should not publish click info to Keen' do
          Keen.should_not_receive(:publish_async)
