...
EOF
  ...
  describe "#search_for" do
    ...
    it "should facet by Manufacturer" do
      ...
      search.facet(:manufacturer_facet).rows.first.count.should == @number_of_recalls
    end
    ...
    it "should facet by RecallType" do
      ...
      search.facet(:recall_type_facet).rows.first.count.should == @number_of_recalls
    end
    ...
    it "should facet by Hazard" do
      ...
      search.facet(:hazard_facet).rows.first.count.should == @number_of_recalls
    end
    ...
    it "should facet by Country" do
      ...
      search.facet(:country_facet).rows.first.count.should == @number_of_recalls
    end
