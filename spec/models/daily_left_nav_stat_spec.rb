  ...
  describe "#collect_to_json(affiliate, start_date, end_date)" do
    context "when data exists for the date range" do
      before do
        ...
        rss1 = @affiliate.rss_feeds.create!(:name => "Feed 1", :url => 'http://www.whitehouse.gov/feed/blog/white-house')
        rss2 = @affiliate.rss_feeds.create!(:name => "Feed 2", :url => 'http://www.whitehouse.gov/feed/blog/white-house')
