...
// Created: 1/20/2010 10:24:10 AM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcstawbig000000c5cymyjrr8_3u9s";
	this.domain="statse.webtrendslive.com";
	this.timezone=-5;
	this.fpcdom=".usa.gov";
	this.onsitedoms="search.usa.gov, www.search.usa.gov, firstgovsearch.gov, searchusa.gov, buscador.gov, buscadorusa.gov, usabuscador.gov, mobile.usa.gov";
	this.downloadtypes="wmv,avi,mp3,xls,xlsx,csv,txt,doc,docx,pdf,zip,gzip,gz,tar,xml";
