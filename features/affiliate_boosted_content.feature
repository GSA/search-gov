Feature: Boosted Content
  ...
  Scenario: Create a new Boosted Content entry
    ...
    And the following Boosted Content entries exist for the affiliate "aff.gov"
     | title            | url                             | description       | keywords          | autogenerated |
     | fresnel lens     | http://www.hello.gov/there.htm  | fire island       | lens              | true          |
    ...
    And I should see "Affiliate aff site has 1 Boosted Content entry."
    ...
    And I should see "Affiliate aff site has 2 Boosted Content entries."
    And I should see the following table rows:
    | Title         | URL                      | Description      | Keywords          | Auto-generated | Actions         |
    | fresnel lens  | www.hello.gov/there.htm  | fire island      | lens              | Yes            | Edit Delete     |
    | Test          | www.test.gov             | Test Description | unrelated, terms  | No             | Edit Delete     |
