Feature: Affiliate Search
  ...
  Scenario: Searching document collections
    ...
    And the following IndexedDocuments exist:
      ...
      | First petition article  | This is an article death star r2d2 petition    | http://petitions.whitehouse.gov/petition-1.html | agency.gov | 11/02/2011      | OK                |
      | Second petition article | This is an article on death r2d2 star petition | http://petitions.whitehouse.gov/petition-2.html | agency.gov | 11/02/2011      | OK                |
    When I am on agency.gov's search page
    And I follow "Petitions" in the left column
    And I fill in "Enter your search term" with "'death star r2d2'"
    And I press "Search" in the search box
